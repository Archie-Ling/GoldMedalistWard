...
public class Disease implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getUserDisease() == null ? other.getUserDisease() == null : this.getUserDisease().equals(other.getUserDisease()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getUserDisease() == null) ? 0 : getUserDisease().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", userDisease=").append(userDisease);
